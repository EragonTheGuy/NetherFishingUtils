import {EntityItem, MCItem, SkullItem, BP, Blocc, Base64, CompressedStreamTools, ByteArrayInputStream} from "../const"
                ...
                if(profile.selected) {
                    ...
                    for(let j = 0; j < items.func_74745_c(); j++) {
                        ...
                        if(itemID.includes("BAIT")) {
                            ...
                            if(!baitsInSack[itemID]) baitsInSack[itemID] = 0
                            baitsInSack[itemID] += itemAmount
                        }
                    }
